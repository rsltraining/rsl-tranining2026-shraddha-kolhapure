...
public class User1Fragment extends Fragment {
    ...
    public interface MessageSender {
        void sendToUser2(String message);
        void sendToUser1(String message);
    }

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        listener = (MessageSender) context;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(v -> {
            ...
            if (!TextUtils.isEmpty(message)) {
                ...
                dialog.setTargetFragment(User1Fragment.this, ConfirmationDialogFragment.REQUEST_CODE);
                dialog.show(getParentFragmentManager(), "dialog_user1");
            }
        });
