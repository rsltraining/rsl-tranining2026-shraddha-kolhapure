...
- (void)viewDidLoad {
    ...
    NSLog(@" 2nd VC - viewDidLoad (Created)");
    ...
    [dismissBtn setTitle:@"Dismiss Screen" forState:UIControlStateNormal];
...
- (void)viewWillAppear:(BOOL)animated { [super viewWillAppear:animated]; NSLog(@" 2nd VC - viewWillAppear"); }
- (void)viewDidAppear:(BOOL)animated { [super viewDidAppear:animated]; NSLog(@" 2nd VC - viewDidAppear"); }
- (void)viewWillDisappear:(BOOL)animated { [super viewWillDisappear:animated]; NSLog(@" 2nd VC - viewWillDisappear"); }
- (void)viewDidDisappear:(BOOL)animated { [super viewDidDisappear:animated]; NSLog(@" 2nd VC - viewDidDisappear"); }
